object recap {
	...
	val words = in.getLines.toList  filter (word => word forall (ch => ch.isLetter))
 	...
 	translate("7225247386")                   //> res0: Set[String] = Set(packairfun, Scalaisfun, sackairfun, packahreto, pac
                                                  //| kbirdto, sackbirdto, rackbirdto, sackahreto, Scalaireto, rackairfun, rackah
                                                  //| reto)
  ...
  wordCode("JAVA")                                //> res2: String = 5282
  wordCode("Java")                                //> res3: String = 5282
}